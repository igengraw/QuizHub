  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <form onSubmit={handleRegister} className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md space-y-4 border border-gray-100">
        <h2 className="text-3xl font-extrabold text-center text-gray-900">Создать аккаунт</h2>
        <p className="text-center text-gray-500 mb-4">Присоединяйтесь к QuizHub сегодня</p>
        ...
        <div className="text-center mt-6">
          ...
          <Link to="/login" className="text-blue-600 font-semibold hover:underline">Войти</Link>
        </div>
      </form>
    </div>
  );
